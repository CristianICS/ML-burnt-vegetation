...
class Dataset:
    ...
    def __init__(self, labels_dataset_path, label_codes_path, version):
        ...
        pcas_df = pd.concat([summerlong_pcas, global_pcas, self.matrix], axis=1)
        self.matrix = pcas_df
    ...
    def define_predictor_groups(self):
        ...
        # Hand-crafted sets
        pred_dict["manual_ndvi_1"] = {"N": ["NDVI_summerlong", "shadow", "dem"], "C": ["acibasi"]}
        pred_dict["manual_1"] = {"N": ["nir_summerlong", "swir1_summerlong", "shadow", "dem"], "C": ["acibasi"]}
        pred_dict["manual_pca_1"] = {"N": ["PC2_summerlong", "PC1_summerlong", "PC1_global"]}
        ...
        pred_dict["vif_1"] = {"N": ["nir_summerlong", "coastal_summerlong", "dem", "shadow", "slope"], "C": ["acibasi"]}
        pred_dict["vif_2"] = pred_dict["vif_1"]
        pred_dict["vif_3"] = {"N": ["nir_summerlong", "dem", "shadow", "slope"], "C": ["acibasi"]}

        # VIF global + PCA combined
        pred_dict["vif_global_1"] = {
            "N": ["coastal_summerlong", "dem", "shadow", "slope", "PC2_summerlong", "PC3_summerlong"],
            "C": ["acibasi"],
        }
